---
title: 阅读DAY2 JavaScript高级程序设计 3章下 语言基础
...
ECMAScript中对象的属性是无序的，因此**for-in语句不能保证返回对象属性的顺序**。所有可枚举的属性都会返回一次，但返回的顺序可能会因浏览器而异。
...
![image-20260417185001693](/assets/blog_res/2026-04-16-read2.assets/image-20260417185001693.png)
